 ...
 * (type × operator) cell — every combination the generated field schema
 * (`querySchema.gen`) admits keeps its capabilities: `fromEmail × in` gets the
 ...
 * @spec docs/eph/DESIGN-L2-rule-actions.md
 */
 ...
 * Types whose schema never offers `in` (`boolean`/`date`/`size` per
 * `querySchema.gen`) omit `ListEntry`; the plain-text entry is the safety net.
 */
