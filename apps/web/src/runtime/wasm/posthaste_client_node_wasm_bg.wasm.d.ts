...
export const nearendhandle_linkId: (a: number) => [number, number];
...
export const wasm_bindgen__convert__closures_____invoke__h28e6bf82b92400ea: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
