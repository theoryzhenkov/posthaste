...
export const QUERY_FIELD_SCHEMA: Record<SmartMailboxField, QueryFieldSchema> = {
  ...
  sourceName: { valueType: 'text', operators: ['equals', 'contains', 'in'] },
  ...
  mailboxName: { valueType: 'text', operators: ['equals', 'contains', 'in'] },
  ...
  fromName: { valueType: 'text', operators: ['equals', 'contains', 'in'] },
  fromEmail: { valueType: 'text', operators: ['equals', 'contains', 'in'] },
