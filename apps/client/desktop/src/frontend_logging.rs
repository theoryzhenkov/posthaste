//! The frontend logging bridge: the webview forwards its console/pino log
//! entries through `log_from_frontend`, and they land in the same rotated
//! JSONL files as the backend's own tracing output.
