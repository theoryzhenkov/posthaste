...
import { ASSIGNABLE_MAILBOX_ROLES } from '../../../domain/vocabulary'
...
import { SmartMailboxAutomationFields } from '../rules/AutomationActionsEditor'
import { EMPTY_SMART_MAILBOX_FORM, formFromSmartMailbox } from '../forms'
import { RuleGroupEditor } from '../rules/RuleGroupEditor'
import { ConditionEditorContext } from '../rules/conditions/conditionEditorContext'
import {
  FeedbackBanner,
  Field,
  SettingsFooter,
