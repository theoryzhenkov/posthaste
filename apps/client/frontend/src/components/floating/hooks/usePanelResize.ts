...
import { RESIZE_DOUBLE_CLICK_MS, RESIZE_DOUBLE_CLICK_SLOP } from '../panel/constants'
import { persistPanelOffset, persistPanelSize, viewportSize } from '../panel/geometry'
