...
- **"Let my AI agent handle it."**
  ...
  wrong the first time. We clear it up here. → [Agents](agents.md)

If you're not sure, start at the top of [Automations](automations.md): it opens
with a short decision guide that points you to the right level.

## The three pages

- **[Automations](automations.md)** — the main guide. The decision guide,
  built-in rules (no code), and running your own script. Read this first.
- **[Agents](agents.md)** — the headline: how to plug your AI agent into
  Posthaste without the usual confusion, with a full worked example.
- **Staying safe** lives at the end of [Automations](automations.md#staying-safe)
  — three rules a human actually needs.
