  ...
  return (
    <header className="install-header" aria-label="Install and navigation">
      ...
      <nav className="install-header-nav" aria-label="Site">
        ...
        <a
          className="install-header-icon"
          href={GITHUB_URL}
          target="_blank"
          rel="noreferrer"
          aria-label="Posthaste on GitHub"
        >
          <GithubMark />
        </a>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label="Posthaste on Discord"
        >
          <DiscordMark />
        </a>
      </nav>
