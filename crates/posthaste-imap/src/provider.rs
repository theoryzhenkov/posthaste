...
use posthaste_domain::{
    GmailLabel, ImapMessageLocation, MailboxId, MessageId, MessageRecord, ProviderProfile,
    SystemKeyword,
};

use crate::{
    message::ImapMailboxMembershipSource, DiscoveredImapAccount, DiscoveredImapMailbox,
    ImapMappedHeader,
};
...
impl GmailCanonicalMessageProfile {
    fn new(mailboxes: &[DiscoveredImapMailbox]) -> Self {
        Self {
    ...
    fn canonical_message_id(message: &MessageRecord) -> MessageId {
