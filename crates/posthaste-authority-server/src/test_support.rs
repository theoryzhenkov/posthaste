...
//!
//! `crate::bootstrap::tests`, `crate::account_repository::tests`, and
//! `crate::supervisor::tests` each used to hand-roll their own
//! `std::env::temp_dir()` + nanos/counter unique-naming helper and never
//! clean up the directory. All now share [`temp_root`] from here instead.
//!
