...
pub mod events {
    ...
    pub const CACHE_BODY_CANDIDATES_SCORED: LogEvent =
        LogEvent::new("cache.body.candidates_scored");
    pub const CACHE_BODY_CANDIDATES_UPSERTED: LogEvent =
        LogEvent::new("cache.body.candidates_upserted");
    pub const CACHE_BODY_DEFERRED_BY_LEASE: LogEvent =
        LogEvent::new("cache.body.deferred_by_lease");
    ...
    pub const CACHE_FETCH_SKIPPED_NO_LEASE: LogEvent =
        LogEvent::new("cache.fetch.skipped_no_lease");
    ...
    pub const JMAP_EMAIL_DELTA_UNAVAILABLE: LogEvent =
        LogEvent::new("jmap.email.delta.unavailable");
    ...
    pub const JMAP_MAILBOX_DELTA_COMPLETED: LogEvent =
        LogEvent::new("jmap.mailbox.delta.completed");
    ...
    pub const JMAP_MAILBOX_FULL_IDS_FETCHED: LogEvent =
        LogEvent::new("jmap.mailbox.full_ids_fetched");
    ...
    pub const IMAP_IDLE_PERIODIC_POLL_ONLY: LogEvent =
        LogEvent::new("imap.idle.periodic_poll_only");
    ...
    pub const IMAP_MAILBOX_SYNC_PLAN_DETAIL: LogEvent =
        LogEvent::new("imap.mailbox.sync_plan_detail");
    ...
    pub const IMAP_SMTP_SENT_APPEND_FAILED: LogEvent =
        LogEvent::new("imap.smtp.sent_append_failed");
    pub const IMAP_SMTP_SENT_MAILBOX_MISSING: LogEvent =
        LogEvent::new("imap.smtp.sent_mailbox_missing");
    pub const IMAP_SYNC_DISCOVERY_COMPLETED: LogEvent =
        LogEvent::new("imap.sync.discovery_completed");
    ...
    pub const SUPERVISOR_GATEWAY_CONNECTING: LogEvent =
        LogEvent::new("supervisor.gateway.connecting");
