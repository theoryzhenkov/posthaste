...
fn fetch_message_before_apply_tx(
    tx: &Transaction<'_>,
    account_id: &AccountId,
...
fn replace_message_conversation_tx(
    tx: &Transaction<'_>,
    account_id: &AccountId,
    message_id: &MessageId,
    conversation_id: &ConversationId,
...
fn replace_message_mailboxes_tx(
    tx: &Transaction<'_>,
    account_id: &AccountId,
    message_id: &MessageId,
...
fn replace_message_keywords_tx(
    tx: &Transaction<'_>,
    account_id: &AccountId,
    message_id: &MessageId,
    keywords: &[String],
...
fn upsert_message_body_cache_tx(
    tx: &Transaction<'_>,
    account_id: &AccountId,
    message: &posthaste_domain::MessageRecord,
    raw_ref: Option<&RawMessageRef>,
...
fn track_applied_message_projection_inputs(
    affected: &mut ProjectionInputs,
    message: &posthaste_domain::MessageRecord,
    conversation_id: &ConversationId,
...
fn append_message_diff_events_tx(
    tx: &Transaction<'_>,
    account_id: &AccountId,
    message: &posthaste_domain::MessageRecord,
    conversation_id: &ConversationId,
...
fn delete_imap_message_location_and_track_projection_inputs(
    tx: &Transaction<'_>,
    account_id: &AccountId,
...
fn prune_stale_imap_message_locations_for_snapshot_tx(
    tx: &Transaction<'_>,
    account_id: &AccountId,
...
fn delete_mailbox_and_track_projection_inputs(
    tx: &Transaction<'_>,
    account_id: &AccountId,
    mailbox_id: &MailboxId,
    affected: &mut ProjectionInputs,
