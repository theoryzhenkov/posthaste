import type { MessageDetail, MessageSummary, Recipient } from '@/api/types'
...
export function isMessageDetailPayload(
  message: MessageDetail | MessageSummary | undefined,
): message is MessageDetail {
  return Array.isArray((message as Partial<MessageDetail>)?.attachments)
}
