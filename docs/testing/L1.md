---
title: "Testing — Contracts (L1)"
scope: L1
summary: "Testkit contract, verification ladder, coverage model, and test-quality standard for Posthaste behavior contracts — the posthaste-testkit harness/fixtures (incl. the mock-Gmail label model) and the apps/web/test/harness client testkit"
modified: 2026-07-04
reviewed: 2026-07-04
state: realized
depends:
...
| 2. Frontend logic | `bun test` (incl. the `apps/web/test/harness` client testkit) | cache invalidation, routing, IPC adapters, replica/worker resilience scenarios | realized |
