---
title: "Replication — Coherent links (L1)"
scope: L1
summary: "Coherent links: the symmetric optimistic-replication mechanism that moves mail state between layers with local optimism, a pending set, and authority-confirmed convergence, composed across client, runtime, and authority server; a far node may serve multiple near nodes"
modified: 2026-07-02
reviewed: 2026-07-02
state: realized
depends:
