...
| Keyword mutation | `LiveImapSmtpGateway::set_keywords`, `apply_imap_keyword_delta_by_location`, `imap_flags_for_keywords` | RFC 9051 `UID STORE`, `+FLAGS.SILENT`, `-FLAGS.SILENT`, and `PERMANENTFLAGS` behavior: <https://www.rfc-editor.org/rfc/rfc9051.html>; `imap-client` `uid_silent_store` and STORE task command construction: <https://docs.rs/crate/imap-client/0.3.0/source/src/client/tokio.rs>, <https://docs.rs/crate/imap-client/0.3.0/source/src/tasks/tasks/store.rs>; `imap-types` flag and store models: <https://docs.rs/crate/imap-types/2.0.0-alpha.6/source/src/flag.rs> |
