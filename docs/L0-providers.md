...
| Lazy body parsing | `imap_body_from_raw_mime` | RFC 9051 `BODY.PEEK[]` does not implicitly set `\Seen`: <https://www.rfc-editor.org/rfc/rfc9051.html>; `mail-parser` body and attachment APIs: <https://docs.rs/mail-parser/0.11.2/mail_parser/struct.Message.html>, <https://docs.rs/crate/mail-parser/0.11.2/source/src/core/message.rs> |
