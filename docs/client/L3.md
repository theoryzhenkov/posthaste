...
Components and hooks call the **intent facades** (`runtime/views`, `runtime/linkClient`, `runtime/mutations`, `runtime/resources`, `runtime/subscriptions`) — not `api/client` mail functions — for any path a runtime operation exists for.
