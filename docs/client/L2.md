...
Hooks use catalogued names such as `message.setReadState`, `message.setFlaggedState`, `message.setUserTags`, `message.moveToMailbox`, `message.moveToRole`, `message.destroy`, `draft.save`, `draft.discard`, `message.send`, `settings.patch`, `account.patch`, `mutation.retry`, `mutation.undo`, and `mutation.resolveConflict`.
