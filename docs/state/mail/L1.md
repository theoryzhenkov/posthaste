...
This domain is transport-neutral. API specs describe how mail state crosses HTTP and SSE. Authority-server specs describe how state is persisted, indexed, synced, and mutated. Runtime and client specs describe how state is operated and rendered.
