...
- Directory convention started 2026-06-14: current rewritten domains live in per-domain subdirectories such as `docs/api/L1.md`, `docs/backend/L2.md`, and nested domains such as `docs/state/mail/L1.md`.
