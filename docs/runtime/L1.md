---
scope: L1
summary: "Runtime roles and bundled application deployment: embedded authority runtime, stateful view operation, instant actions, and future replica transparency. Shared contract over the adapter, mutations, and internals sub-domains"
modified: 2026-06-24
reviewed: 2026-06-24
state: realized
depends:
