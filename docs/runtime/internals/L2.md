---
title: "Runtime internals — Assembly (L2)"
scope: L2
...
Shutdown stops UI links and account runtimes, flushes durable local state,
...
emission, window/link labels, local capability injection, focused-window
