---
title: "Runtime mutations — Catalog (L1)"
scope: L1
...
depends:
  ...
  - path: docs/replication/L1
    section: "4. Up-channel: optimistic mutations and the pending set"
...
comparison), submitter link, affected resources, provider work state, and
